<div class="main-content w-100 float-start">
    <div class="container">
        <div class="row">
            <div class="content-wrapper col-xl-12 col-lg-12 order-lg-2">
                <div class="tab-content text-center products w-100 float-left category-col-5">
                    <div class="tab-pane grid fade active" id="grid" role="tabpanel">
                        <div class="row">
                            <div class="product-layouts col-lg-4 col-md-4 col-sm-6 col-6">
                                <div class="product-thumb">
                                    <div class="image zoom">
                                        <a href="product-details.html">
                                            <img src="https://pos.nvncdn.com/e41e16-5527/ps/20250409_g99UaduFiU.jpeg"
                                                alt="01" />
                                            <img src="https://pos.nvncdn.com/e41e16-5527/ps/20250409_g99UaduFiU.jpeg"
                                                alt="02" class="second_image img-fluid" /> </a>
                                    </div>
